  ...
  head: () => ({
    meta: [
      ...
      { title: "Saubhagya Singh — Full Stack Developer & AI Enthusiast" },
      {
        name: "description",
        content:
          "Portfolio of Saubhagya Singh: full stack developer, AI enthusiast and B.Tech CSE student.",
      },
      { name: "author", content: "Saubhagya Singh" },
      { property: "og:title", content: "Saubhagya Singh — Full Stack Developer" },
      {
        property: "og:description",
        content: "Modern web applications, AI exploration and daily DSA practice.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico (2).png", type: "image/png" },
    ],
  }),
